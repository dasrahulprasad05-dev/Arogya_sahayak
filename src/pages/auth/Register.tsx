...
import { Activity, Mail, Lock, User as UserIcon, ShieldAlert, ArrowRight, Eye, EyeOff } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-card border border-border rounded-2xl p-8 shadow-xl glass">
        ...
        <h2 className="text-xl font-semibold mb-6 text-center">{t('auth.register_title')}</h2>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="ଭଞ୍ଜ ଦେବ / Bhaja Deb"
                value={name}
