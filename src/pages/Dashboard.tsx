...
const Dashboard: React.FC = () => {
  ...
  const handleQuickVitals = (_feeling: string) => { logVitals({ systolic: 120, diastolic: 80, heartRate: 72, spO2: 98 }); setSuccessVitals(true); setTimeout(() => setSuccessVitals(false), 1500); };
