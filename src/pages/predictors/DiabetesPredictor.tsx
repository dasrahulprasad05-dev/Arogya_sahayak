  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto relative overflow-hidden pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        {/* Form Panel (7 cols) */}
        <form onSubmit={handleSubmit} className="lg:col-span-7 bg-white/40 dark:bg-card/40 border border-cyan-500/15 rounded-2xl p-6 shadow-xl backdrop-blur-md relative space-y-5 animate-slide-up">
        ...
        <div className="lg:col-span-5 animate-slide-up" style={{ animationDelay: '100ms' }}>
          ...
          {result ? (
            ...
            <div className="bg-card/45 border border-cyan-500/15 rounded-2xl p-8 text-center text-slate-400 text-xs font-semibold py-20 backdrop-blur-md relative overflow-hidden min-h-[400px] flex flex-col items-center justify-center gap-4 shadow-xl">
